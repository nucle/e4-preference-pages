package at.nucle.e4.plugin.preferences.core.internal.context;
...
public class PreferenceScopeContext extends EventManager implements IPreferenceStore {
	...
	private INodeChangeListener getNodeChangeListener() {
		return new IEclipsePreferences.INodeChangeListener() {
			 ...
			 * INodeChangeListener#added(org.eclipse.core.
			 ...
			 *
			 * @see org.eclipse.core.runtime.preferences.IEclipsePreferences.
			 * INodeChangeListener#removed(org.eclipse.core.
			 * runtime.preferences.IEclipsePreferences.NodeChangeEvent)
			 */
			@Override
	...
	private void initializePreferencesListener() {
		if (preferencesListener == null) {
			preferencesListener = new IEclipsePreferences.IPreferenceChangeListener() {
				 ...
				 * IPreferenceChangeListener#preferenceChange(
				 * org.eclipse.core.runtime.preferences.IEclipsePreferences.
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.jface.preference.IPreferenceStore#getBoolean(java.lang.
	 * String)
	 */
	@Override
	 ...
	 * removePropertyChangeListener(org.eclipse.jface.util.
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.jface.preference.IPreferenceStore#setDefault(java.lang.
	 * String, double)
	 */
	@Override
